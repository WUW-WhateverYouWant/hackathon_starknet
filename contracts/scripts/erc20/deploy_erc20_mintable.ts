...
async function main() {
  ...
  // ["TESTOR","TEST",init_supply,"0x04303C60233Ca91F72e53bE1A745E9D35cBbe7130E7438f716C8b4BC69852159"]c
  console.log("accountAddress",accountAddress)
  const { transaction_hash: th2, address } = await account0.deployContract(
    {
      classHash: contractClassHash,
      constructorCalldata: [name, symbol, init_supply, accountAddress.toString()],
    },
    {nonce:nonce}
  );
